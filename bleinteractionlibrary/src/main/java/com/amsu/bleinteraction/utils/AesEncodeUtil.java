...
public class AesEncodeUtil {  
    ...
    //初始向量  
    public static final String VIPARA = "AES00IVPARAMETER";   //AES 为16bytes. DES 为8bytes  
      
    //编码方式  
    public static final String bm = "UTF-8";  
      
    //私钥  
    private static final String ASE_KEY="AMSU2015AMSU2015";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。  
    ...
    public static byte[] encryptReturnBytes(String cleartext){
        //加密方式： AES128(CBC/PKCS5Padding) + Base64, 私钥：aabbccddeeffgghh  
        try {  
            IvParameterSpec zeroIv = new IvParameterSpec(VIPARA.getBytes());  
            //两个参数，第一个为私钥字节数组， 第二个为加密方式 AES或者DES  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        // 解密  
        //String decryptResult = decrypt("l+oOkdiryNVN2NJaNq1YIw==");
        //System.out.println("解密后：" + new String(decryptResult));
        
        byte[] bytes = "vpmsfyLyORC4Cy50LU75qA==".getBytes();
