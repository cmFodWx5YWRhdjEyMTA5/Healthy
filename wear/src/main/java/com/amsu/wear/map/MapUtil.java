...
public class MapUtil {
	...
	public static List<ParcelableDoubleList> getLatitude_longitudeString(PathRecord pathRecord) {
		List<LatLng> latLngList = MapUtil.parseLatLngList(pathRecord.getPathline());
   ...
   /* public static long saveRecord(List<AMapLocation> list, String time, Context context, long startTime,double allDistance) {
        if (list != null ) {
            ...
            MapDbAdapter dbAdapter = new MapDbAdapter(context);
            dbAdapter.open();
	 ...
	 * @param aMapLocation
	 */
	public static double getTwoPointDistance(AMapLocation lastAMapLocation,AMapLocation aMapLocation) {
		...
		return getTwoPointDistance(thisLatLng, lastLatLng);
	}

	public static double getTwoPointDistance(LatLng thisLatLng,LatLng lastLatLng) {
