...
public class HRVQuarterFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        inflate = inflater.inflate(R.layout.fragment_hrv_quarter, container, false);
        initView();
    ...
    private void initView() {
        ...
        tv_ecgmouth_type.setText("季度HRV报告");
