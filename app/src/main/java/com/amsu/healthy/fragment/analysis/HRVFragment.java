            ...
            if (mUploadRecord.sdnn1==0 && mUploadRecord.sdnn2==0 && mUploadRecord.lf1==0 && mUploadRecord.lf2==0 && mUploadRecord.hf1==0 && mUploadRecord.hf2==0
                ...
                if (calTime>0 || mUploadRecord.sdnn1>0){
                    ...
                    if (mentalFatigueNumber.state>0){
                        tiredLayoutParams.setMargins((int) ((mentalFatigueNumber.state*18/100.0)*progressWidth), (int) -getResources().getDimension(R.dimen.x23),0,0);
                    ...
                    if (physicalFatigueNumber.state>0){
                        resistLayoutParams.setMargins((int) ((physicalFatigueNumber.state*23/100.0)*progressWidth), (int) -getResources().getDimension(R.dimen.x23),0,0);
