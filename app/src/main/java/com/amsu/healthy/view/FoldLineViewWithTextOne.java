...
public class FoldLineViewWithTextOne extends View {
    private int mHeight;
    ...
    public FoldLineViewWithTextOne(Context context) {
        super(context);
        init(context,null);
    }

    public FoldLineViewWithTextOne(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs);
    }

    public FoldLineViewWithTextOne(Context context, AttributeSet attrs, int defStyleAttr) {
