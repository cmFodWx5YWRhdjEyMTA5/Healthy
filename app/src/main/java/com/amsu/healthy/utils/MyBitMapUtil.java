...
public class MyBitMapUtil {
    ...
    public static File saveBitmapFile(Bitmap bitmap, Context context){
        String compressImagePath = context.getCacheDir()+"/"+System.currentTimeMillis()+".png";
        File file=new File(compressImagePath);//将要保存图片的路径
        /*if (!file.exists()){
        ...
        Log.i("file","file:"+file+",path:"+file.getAbsolutePath());
        return file;
    }
}
